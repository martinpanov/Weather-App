...
const WeatherInfo = ({
  ...
  useEffect(() => {
    ...
    const filteredTodaysWeather = fiveDaysWeather.filter(
      (weather) => weather.date === todaysDate
    );
      ...
      <div className={styles['aside__weather-details']}>
        ...
        <ul className={styles['aside__weather-info-list']} role="list">
          {weatherDetails.map((detail) => (
            <li
              className={styles['aside__weather-info-list-item']}
              key={detail.name}
            >
              ...
              <RenderIf condition={!loading}>
                <span className={styles['aside__weather-info-type']}>
                  {detail.name}
                </span>
